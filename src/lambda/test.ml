...
let print_sign (t,l) =
  ...
  let list_decl = Tries.Tries.content trie in
    ...
    let list_res = Sign.Display.pretty_print t l(*list_decl*) content
(*       Sign.Sign.to_stringbis t *)
...
(* 		 print_string " : "; *)
(* 		 Sign.Display.display_typ_tdef t typ; *)
(* 		 print_string " ;\n "; *)
(* 		 new_l *)
...
(* 		 let new_l = s::var_l in *)
(* 		 print_string (s^" : K["); *)
(* 		 List.iter (Sign.Display.display_typ_tdef t) tdl; *)
(* 		 print_string "] ;\n "; *)
(* 		 new_l)) *)
(* 	[]  *)
(* 	list_decl *)
